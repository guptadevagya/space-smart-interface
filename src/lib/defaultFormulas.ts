...
export function getDefaultFormulas(region: Region): FormulaDefinition[] {
  ...
  const demographics: FormulaDefinition[] = [
    {
      id: 'totalFGR',
      name: 'Total FGR Cases',
      formula: 'annualBirths * fgrPrevalence',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
    {
      id: 'detectedCurrent',
      name: 'Detected (Current)',
      formula: 'totalFGR * currentDetectionRate',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
    {
      id: 'undiagnosedCurrent',
      name: 'Undiagnosed (Current)',
      formula: 'totalFGR - detectedCurrent',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
    {
      id: 'detectedOxailis',
      name: 'Detected (OxNNet)',
      formula: 'totalFGR * oxailisDetectionRate',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
    {
      id: 'undiagnosedOxailis',
      name: 'Undiagnosed (OxNNet)',
      formula: 'totalFGR - detectedOxailis',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
    {
      id: 'avoidedUndiagnosed',
      name: 'Avoided Undiagnosed',
      formula: 'undiagnosedCurrent - undiagnosedOxailis',
      group: 'demographics',
      format: 'number',
      unit: 'cases',
    },
  ...
  const clinical: FormulaDefinition[] = [
    {
      id: 'avoidedCSections',
      name: 'Avoided C-Sections',
      formula: isUK
        ? 'avoidedUndiagnosed * 0.15'
        : 'avoidedUndiagnosed * emergencyCSectionRateUndiagnosed',
      group: 'clinical',
      format: 'number',
    },
    {
    ...
    {
      id: 'avoidedNICUDays',
      name: 'Avoided NICU Days',
      formula: 'avoidedHypoxicEvents * 7',
      group: 'clinical',
      format: 'number',
      unit: 'days',
    },
    {
      id: 'avoidedCPCases',
      name: 'Avoided CP Cases',
      formula: 'avoidedHypoxicEvents * cerebralPalsyRisk',
      group: 'clinical',
      format: 'number',
    },
    {
      id: 'avoidedStillbirths',
      name: 'Avoided Stillbirths',
      formula: 'avoidedUndiagnosed * 0.0168',
      group: 'clinical',
      format: 'number',
    },
  ];
  ...
  if (isUK) {
    clinical.push({
      id: 'avoidedNND',
      name: 'Avoided Neonatal Deaths',
      formula: 'avoidedHypoxicEvents * 0.09',
      group: 'clinical',
      format: 'number',
    });
  }
  ...
  const financial: FormulaDefinition[] = [
    {
      id: 'cSectionSavings',
      name: 'C-Section Savings',
      formula: 'avoidedCSections * cSectionCost',
      group: 'financial',
      format: 'currency',
    },
    {
      id: 'nicuSavings',
      name: 'NICU Savings',
      formula: 'avoidedNICUDays * nicuDailyCost',
      group: 'financial',
      format: 'currency',
    },
  ];
  ...
  if (isUK) {
    financial.push(
      {
        id: 'mumExtraStaySavings',
        name: 'Mum Extra Stay Savings',
        formula: 'avoidedHypoxicEvents * 2537.333333',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'stillbirthSavings',
        name: 'Stillbirth Cost Avoidance',
        formula: 'avoidedStillbirths * stillbirthLitigationCost',
        group: 'financial',
        format: 'currency',
      },
      {
        ...
        formula: 'avoidedCPCases * malpracticeClaimCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'nndSavings',
        name: 'NND Litigation Savings',
        formula: 'avoidedNND * neonatalDeathLitigationCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'nndTrustCost',
        name: 'NND Trust Cost Savings',
        formula: 'avoidedNND * stillbirthLitigationCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'nndTotalCostSaving',
        name: 'NND Total Cost Saving to NHS',
        formula: 'nndSavings + nndTrustCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'totalClinicalSavings',
        name: 'Total Saving to NHS',
        formula:
          'cSectionSavings + nicuSavings + mumExtraStaySavings + stillbirthSavings + cpSavings + nndSavings + nndTotalCostSaving',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'highRiskCurrent',
        name: 'High Risk Cohort (Current)',
        formula: 'detectedCurrent / (1 - currentFalsePositiveRate)',
        group: 'financial',
        format: 'number',
      },
      {
        id: 'highRiskOxailis',
        name: 'High Risk Cohort (OxNNet)',
        formula: 'detectedOxailis / (1 - oxailisFalsePositiveRate)',
        group: 'financial',
        format: 'number',
      },
      {
        id: 'costPerHighRisk',
        name: 'Cost per High-Risk Patient',
        formula:
          '(3 * growthScanCost) + (2 * consultantAppointmentCost) + (consultantAppointmentCost - midwifeAppointmentCost)',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'screeningCostIncrease',
        name: 'Extra High-Risk Pathway Cost',
        formula: '(highRiskOxailis - highRiskCurrent) * costPerHighRisk',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'oxailisScreeningCost',
        name: 'Oxailis Screening Cost',
        formula: 'annualBirths * combinedTestRate * oxailisScanCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'totalScreeningCost',
        name: 'Total New Screening Cost',
        formula: 'screeningCostIncrease + oxailisScreeningCost',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'netBenefit',
        name: 'Net Benefit (Total Saving by NHS)',
        formula: 'totalClinicalSavings - totalScreeningCost',
        group: 'financial',
        format: 'currency',
      },
    );
    ...
    financial.push(
      ...
      },
      {
        id: 'totalSavings',
        name: 'Total Savings',
        formula: 'cSectionSavings + nicuSavings + litigationSavings',
        group: 'financial',
        format: 'currency',
      },
      {
        id: 'highRiskCohortOxailis',
        name: 'High Risk Cohort (OxNNet)',
        formula: 'detectedOxailis / (1 - oxailisFalsePositiveRate)',
        group: 'financial',
        format: 'number',
      ...
      {
        id: 'totalScansOxailis',
        name: 'Total Scans (OxNNet)',
        formula: 'highRiskCohortOxailis * 3',
        group: 'financial',
        format: 'number',
      },
      {
        ...
        formula: 'totalScansOxailis * scanReimbursement',
        group: 'financial',
        format: 'currency',
      },
      {
